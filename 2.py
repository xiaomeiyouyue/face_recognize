...
def face_detect_demo(image):
    ...
    face_detector = cv.CascadeClassifier("D:/software/OpenVino/python 3.6.5/Lib/site-packages/cv2/data/haarcascade_frontalface_alt_tree.xml")
...
capture = cv.VideoCapture("C:/Users/wangdachui/Downloads/1/face_recognize/1.mp4")
